...
export function CtaRow({
  ...
  return (
    <div className={`flex flex-wrap items-center gap-3 ${justify} ${className}`}>
      ...
      <a
        href={PHONE_HREF}
        className={`inline-flex min-h-[48px] items-center gap-2 rounded-md border-[1.5px] px-5 py-3.5 text-base font-semibold transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-accent)] focus-visible:ring-offset-2 ${phone}`}
